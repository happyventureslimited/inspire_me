...
extension StoryQueryFilter on QueryBuilder<Story, Story, QFilterCondition> {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> titleContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'title',
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> titleMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'title',
...
extension StoryQueryWhereDistinct on QueryBuilder<Story, Story, QDistinct> {
  QueryBuilder<Story, Story, QDistinct> distinctByCategory(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Story, Story, QDistinct> distinctByContent(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Story, Story, QDistinct> distinctByIsSaved() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Story, Story, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension StoryQueryProperty on QueryBuilder<Story, Story, QQueryProperty> {
  ...
  QueryBuilder<Story, String, QQueryOperations> categoryProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'category');
    });
  }

  QueryBuilder<Story, String, QQueryOperations> contentProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'content');
    });
  }

  QueryBuilder<Story, bool, QQueryOperations> isSavedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Story, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
