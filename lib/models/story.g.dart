...
Story _storyDeserialize(
  ...
  object.savedAt = reader.readDateTimeOrNull(offsets[4]);
...
extension StoryQueryFilter on QueryBuilder<Story, Story, QFilterCondition> {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> lessonContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'lesson',
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> savedAtIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> savedAtIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> savedAtEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'savedAt',
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> savedAtGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> savedAtLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> savedAtBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension StoryQuerySortBy on QueryBuilder<Story, Story, QSortBy> {
  ...
  QueryBuilder<Story, Story, QAfterSortBy> sortBySavedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'savedAt', Sort.asc);
    });
  }

  QueryBuilder<Story, Story, QAfterSortBy> sortBySavedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension StoryQuerySortThenBy on QueryBuilder<Story, Story, QSortThenBy> {
  ...
  QueryBuilder<Story, Story, QAfterSortBy> thenBySavedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'savedAt', Sort.asc);
    });
  }

  QueryBuilder<Story, Story, QAfterSortBy> thenBySavedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'savedAt', Sort.desc);
    });
  }
...
extension StoryQueryWhereDistinct on QueryBuilder<Story, Story, QDistinct> {
  ...
  QueryBuilder<Story, Story, QDistinct> distinctBySavedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension StoryQueryProperty on QueryBuilder<Story, Story, QQueryProperty> {
  ...
  QueryBuilder<Story, DateTime?, QQueryOperations> savedAtProperty() {
    return QueryBuilder.apply(this, (query) {
